      ...
      <Box component="main" sx={{ p: 1 }}>
        ...
        <Grid container>
          <Grid item xs={12} md={8}>
            <Typography>
              <div className="ml-4">
                <img src={img} alt="campus map" className="h-[90vh]" />
              </div>
            </Typography>
          </Grid>
    ...
    >
      <CardContent sx={{ color: "white", textAlign: "center" }}>
        <Typography
          ...
          variant="h5"
          component="div"
          sx={{ marginTop: 5, fontSize: "40px", fontWeight: 650 }}
        >
          Book an Appointment
        </Typography>
      ...
      <CardActions
        sx={{ justifyContent: "center", marginTop: 10, marginBottom: 10 }}
      >
        <Button
          variant="contained"
          color="error"
          sx={{ width:500, borderRadius: 7, fontWeight: 800 }}
        >
          Submit
        </Button>
      </CardActions>
